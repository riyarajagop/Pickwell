...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.appHeader}><View style={styles.logo}><Image accessibilityLabel="Pickwell logo" source={require("./assets/pickwell-icon.png")} style={styles.logoMark} /><Text style={styles.logoText}>pickwell</Text></View><Text style={styles.privateText}>● Private on this device</Text></View>
